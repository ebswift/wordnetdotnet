...
#include <unistd.h>
#include "useful.h"
#define START_PROG "./start-state-tagger" // TDMS 29 Sept 2005 - added './' to allow windows-friendly sh execution
#define END_PROG "./final-state-tagger" // TDMS 29 Sept 2005 - added './' to allow windows-friendly sh execution
